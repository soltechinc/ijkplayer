...
IIJK_FFMPEG_UPSTREAM=https://github.com/soltechinc/FFmpeg-Telular.git
IJK_FFMPEG_FORK=https://github.com/soltechinc/FFmpeg-Telular.git
IJK_FFMPEG_COMMIT=ArloChanges-ff3.0-ijk0.5.0
IJK_FFMPEG_FORK=https://github.com/Bilibili/FFmpeg.git
